...
from .encoder_decoder import EncoderDecoder, ChangeEncoderDecoder
...
class CascadeEncoderDecoder(EncoderDecoder):
    ...
    def _decode_head_forward_train(self, x, img_metas, gt_semantic_seg):
        ...
        for i in range(1, self.num_stages):
            ...
            loss_decode, seg_logits = self.decode_head[i].forward_train(
...
@SEGMENTORS.register_module()
class ChangeCascadeEncoderDecoder(ChangeEncoderDecoder):
    ...
    def __init__(self,
                 ...
                 init_cfg=None):
        self.num_stages = num_stages
        super(ChangeCascadeEncoderDecoder, self).__init__(
            backbone=backbone,
            decode_head=decode_head,
            change=change,
            neck=neck,
